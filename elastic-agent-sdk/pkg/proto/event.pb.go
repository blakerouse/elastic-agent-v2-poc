...
func (x *SendEvents) GetEvents() []*Event {
	if x != nil {
		return x.Events
	}
	return nil
...
func (x *SendEventsResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendEventsResult) ProtoMessage() {}

func (x *SendEventsResult) ProtoReflect() protoreflect.Message {
	mi := &file_proto_event_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendEventsResult.ProtoReflect.Descriptor instead.
func (*SendEventsResult) Descriptor() ([]byte, []int) {
	return file_proto_event_proto_rawDescGZIP(), []int{2}
}

func (x *SendEventsResult) GetSent() []uint64 {
	if x != nil {
		return x.Sent
	}
	return nil
...
var file_proto_event_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2b, 0x0a, 0x05, 0x45, 0x76,
	...
	0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x32, 0x0a, 0x0a, 0x53, 0x65, 0x6e, 0x64, 0x45,
	...
	,
...
var file_proto_event_proto_goTypes = []interface{}{
	...
	(*SendEvents)(nil),       // 1: proto.SendEvents
	(*SendEventsResult)(nil), // 2: proto.SendEventsResult
}
var file_proto_event_proto_depIdxs = []int32{
	0, // 0: proto.SendEvents.events:type_name -> proto.Event
	1, // 1: proto.Events.Send:input_type -> proto.SendEvents
	2, // 2: proto.Events.Send:output_type -> proto.SendEventsResult
