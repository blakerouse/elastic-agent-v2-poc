...
func NewCA() (*CertificateAuthority, error) {
	...
	if err != nil {
		return nil, errors.New("ca creation failed")
	}
	...
	if err != nil {
		return nil, errors.New("signing ca certificate")
	}

	// Private key
	err = pem.Encode(keyOut, &pem.Block{Type: "RSA PRIVATE KEY", Bytes: x509.MarshalPKCS1PrivateKey(privateKey)})
	if err != nil {
		return nil, errors.New("generating ca private key")
	}
	...
	if err != nil {
		return nil, errors.New("generating ca x509 pair")
	}
...
func (c *CertificateAuthority) GeneratePairWithName(name string) (*Pair, error) {
	...
	if err != nil {
		return nil, errors.New("signing certificate")
	}
	...
	if err != nil {
		return nil, errors.New("generating public key")
	}

	// Private key
	err = pem.Encode(keyOut, &pem.Block{Type: "RSA PRIVATE KEY", Bytes: x509.MarshalPKCS1PrivateKey(privateKey)})
	if err != nil {
		return nil, errors.New("generating private key")
	}

	// TLS Certificate
	tlsCert, err := tls.X509KeyPair(certOut.Bytes(), keyOut.Bytes())
	if err != nil {
		return nil, errors.New("creating TLS certificate")
	}
